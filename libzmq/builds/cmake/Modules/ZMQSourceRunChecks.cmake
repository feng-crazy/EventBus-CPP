...
int main(int argc, char *argv [])
{
    pthread_setname_np (this_thread::get_id(), \"foo\");
    return 0;
}
"
...
int main(int argc, char *argv [])
{
    pthread_setname_np (this_thread::get_id(), \"foo\", (void *)0);
    return 0;
}
"
...
int main(int argc, char *argv [])
{
    pthread_set_name_np (this_thread::get_id(), \"foo\");
    return 0;
}
"
...
{
    cpu_set_t test; 
    pthread_setaffinity_np (this_thread::get_id(), sizeof(cpu_set_t), &test);
    return 0;
}
"
